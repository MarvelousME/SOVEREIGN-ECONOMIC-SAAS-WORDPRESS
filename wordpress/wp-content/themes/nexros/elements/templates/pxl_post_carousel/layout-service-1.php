...
$button_text = $widget->get_setting('button_text','Explore now');
...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-slider pxl-service-carousel pxl-service-carousel1 pxl-service-style1 pxl-swiper-boxshadow <?php echo esc_attr($style_l11); ?>" <?php if($drap !== false): ?>data-cursor-drap="<?php echo esc_html('DRAG', 'nexros'); ?>"<?php endif; ?>>
  ...
  <path d="M8.33333 1.2334L13 5.90007M13 5.90007L8.33333 10.5667M13 5.90007L1 5.90006" stroke="#0B282E" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                                        </a>
                                    </div>
                                <?php endif; ?>

...
if(isset($settings['slider1']) && !empty($settings['slider1']) && count($settings['slider1'])): ?>
    <div class="pxl-swiper-slider pxl-slider-carousel pxl-slider-carousel1 pxl-drag-area pxl-parent-transition pxl-parent-cursor pxl-swiper-arrow-show <?php echo esc_attr($settings['style']); ?> <?php if($arrows == 'true') { echo esc_attr__( 'pxl-show-arrow', 'nexros' ); } ?>" data-view-auto="<?php echo esc_attr($col_xl); ?>">

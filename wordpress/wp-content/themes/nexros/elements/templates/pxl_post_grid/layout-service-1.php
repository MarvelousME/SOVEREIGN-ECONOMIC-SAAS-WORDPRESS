...
$grid_class = '';
$grid_class = 'pxl-grid-inner d-flex-wrap relative row pxl-accordion';
...
$active = $widget->get_setting('active');
...
if( count($posts) <= 0){
    echo '<div class="pxl-no-post-grid">'.esc_html__( 'No Post Found', 'nexros' ). '</div>';
    return;
} ?>

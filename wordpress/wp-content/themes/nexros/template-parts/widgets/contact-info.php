...
class PXL_Contact_Info_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            ...
            esc_html__('Nexros Contact Info', 'nexros'),
            array('description' => esc_html__('Show Author Information', 'nexros'),)
        );
    }
        ...
        <div class="pxl-contact-info-widget bg-image" style="background-image: url(<?php echo esc_url($bg_box_url)?>); ?>);">
            <div class="content-inner">
                ...
                <?php if (!empty($description)): ?>
                    <div class="pxl-item--desc"><?php echo nexros_html(nl2br($description)); ?></div>
                <?php endif; ?>
    ...
    function form($instance)
    {
        ...
        <div class="author-image-wrap">
            <label for="<?php echo esc_url($this->get_field_id('bg_box')); ?>"><?php esc_html_e('Author Image', 'nexros'); ?></label>
            ...
            if ($bg_box != "") {
                ?>
                <a href="#" class="pxl-select-image pxl-btn" style="display: none;"><?php esc_html_e('Select Image', 'nexros'); ?></a>
                <a href="#" class="pxl-remove-image pxl-btn"><?php esc_html_e('Remove Image', 'nexros'); ?></a>
                <?php
            } else {
                ?>
                <a href="#" class="pxl-select-image pxl-btn"><?php esc_html_e('Select Image', 'nexros'); ?></a>
                <a href="#" class="pxl-remove-image pxl-btn" style="display: none;"><?php esc_html_e('Remove Image', 'nexros'); ?></a>
                <?php
            }
            ?>
        </div>
        ...
        <p>
            <label for="<?php echo esc_url($this->get_field_id('phone_number')); ?>"><?php esc_html_e( 'Phone Number', 'nexros' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_url($this->get_field_id('phone_link')); ?>"><?php esc_html_e( 'Phone Link', 'nexros' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_url($this->get_field_id('description')); ?>"><?php esc_html_e('Description', 'nexros'); ?></label>

...
; (function ($) {
    ...
    if (navigator.userAgent.indexOf('Chrome') == -1) {
        ...
        // Add data-lenis-prevent attribute to prevent Lenis from affecting these elements
        $.each(preventSelectors, function (i, selector) {
            $(selector).attr('data-lenis-prevent', '');
        });
        ...
        $.each(pauseSelectors, function (i, selector) {

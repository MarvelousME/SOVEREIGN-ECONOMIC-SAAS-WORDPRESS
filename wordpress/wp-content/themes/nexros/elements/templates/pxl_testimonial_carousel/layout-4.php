...
if(isset($settings['testimonial']) && !empty($settings['testimonial']) && count($settings['testimonial'])): ?>
    <div class="pxl-swiper-slider pxl-testimonial-carousel pxl-testimonial-carousel4 <?php echo esc_attr($settings['style']); ?>" <?php if($drap !== false) : ?>data-cursor-drap="<?php echo esc_html('DRAG', 'nexros'); ?>"<?php endif; ?>>
                    ...
                    <?php foreach ($settings['testimonial'] as $key => $value):
                        ...
                        <div class="pxl-swiper-slide">
                            ...
                            <?php if(!empty($heading)): ?>
                                <div class="pxl-item--heading"><?php echo esc_html($heading); ?></div>
                              <?php endif; ?>
    ...
    <?php if($pagination !== false || $arrows !== false): ?>
        ...
        <?php if($arrows !== false): ?>
            <div class="pxl-wrap-arrow pxl-flex-middle <?php echo esc_attr($settings['arrows_type']); ?>">

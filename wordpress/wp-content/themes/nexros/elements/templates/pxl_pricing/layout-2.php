<div class="pxl-pricing pxl-pricing__style-2 <?php echo esc_attr( $settings['active_l4'] === 'true' ? 'pxl-pricing__active' : '' ); ?> <?php echo esc_attr( $settings['pxl_animate'] ); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms" >

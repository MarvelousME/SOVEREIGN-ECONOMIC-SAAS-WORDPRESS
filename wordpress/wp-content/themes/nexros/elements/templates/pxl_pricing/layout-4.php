<div class="pxl-pricing pxl-pricing__style-4 <?php echo esc_attr( $settings['active_l4'] === 'true' ? 'pxl-pricing__active' : '' ); ?> <?php echo esc_attr($settings['pxl_animate']); ?>" style="<?php if ($settings['active_l4'] === 'true') { echo 'background-image: url(' . esc_url($settings['img_l4']['url']) . ');'; } ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms" >
    <div class="pxl-pricing__top">
        <?php if (!empty($settings['popular_text_l4'])) : ?>
            <div class="pxl-pricing__popular">
                <?php pxl_print_html( $widget->parse_text_editor( $settings['popular_text_l4'] ) ); ?>
            </div>
        <?php endif; ?>
        <?php if (!empty($settings['plan_l4'])) : ?>
            <h5 class="pxl-pricing__title">
                <?php pxl_print_html( $widget->parse_text_editor( $settings['plan_l4'] ) ); ?>
            </h5>
        <?php endif; ?>
